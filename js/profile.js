window.onload = function() {
    ...
    if (profileImgSrc) {
        document.getElementById('profile-img').src = '/fitness/assets/img/' + profileImgSrc; // Update profile image source
    }
...
function changeProfilePic(src) {
    document.getElementById('profile-img').src = '/fitness/assets/img/' + src;
